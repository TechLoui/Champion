import { getAdminStore } from './admin-store.js?v=20260828-10';
import { PRODUCT_ALIASES, formatBRL, normalizeProduct, getMinPrice, getDisplayImage } from './product-data.js?v=20260828-10';
