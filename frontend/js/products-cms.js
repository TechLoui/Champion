import { getAdminStore } from './admin-store.js?v=20260902-3';
import { PRODUCT_ALIASES, formatBRL, normalizeProduct, getMinPrice, getDisplayImage } from './product-data.js?v=20260902-3';
